...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.DashboardOJTInProgress"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.DashboardTotalNumber"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.ProjectDetail"
                                            }
                                        }
                                    }
                                }
        ...
        "/tasks/{task-id}/comments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "enter type for get report or comment",
                        "name": "type",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "model.DashboardTotalNumber": {
            "type": "object",
            "properties": {
                "total-intern-in-progress": {
                    "type": "integer"
                },
